...
function LandingPage() {
  ...
  return (
    <>
      ...
      <div
        id="default-carousel"
        className="relative w-full z-0 dark:bg-primary-950"
        data-carousel="slide"
      >
        <div className="relative h-56 overflow-hidden rounded-lg md:h-96 dark:bg-primary-950">
          <div
            className="hidden duration-700 ease-in-out dark:bg-primary-950"
            data-carousel-item
          >
            <img
              src="https://flowbite.com/docs/images/carousel/carousel-1.svg"
              className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 dark:bg-primary-950"
              alt="..."
            />
          </div>
